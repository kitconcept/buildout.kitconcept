...
RUN apt-get -y update && apt-get install -y python-dev python-docutils python-virtualenv python-pip zlib1g-dev build-essential libldap2-dev libsasl2-dev libreadline6-dev libncurses5-dev libncursesw5-dev libsqlite3-dev libssl-dev tk-dev libgdbm-dev libc6-dev libbz2-dev libxslt1-dev libpcre3-dev libjpeg62-dev wget git
